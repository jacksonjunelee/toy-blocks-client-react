...
describe("Reducers::Nodes", () => {
  ...
  it("should handle ADD_BLOCK_START", () => {
    const appState = {
      list: [nodeA, nodeB],
    };
    const action = { type: ActionTypes.ADD_BLOCK_START, node: nodeA };
    const expected = {
      list: [
        {
          ...nodeA,
  ...
  it("should handle ADD_BLOCK_SUCCESS", () => {
    const appState = {
      list: [nodeA, nodeB],
    };
    const action = {
  ...
  it("should handle ADD_BLOCK_FAILURE", () => {
    const appState = {
      list: [
        {
          ...nodeA,
